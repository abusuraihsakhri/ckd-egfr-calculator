"""
Automated Pytest for ckd-egfr-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    EgfrTrajectoryModelingEngine,
    NephrologyConsultAutogenerationEngine,
    CurrentStatusEngine,
    TrajectoryEngine,
    DrugRiskAssessmentEngine,
    RecommendationsEngine,
    CkdegfrcalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = CkdegfrcalculatorEnrichmentSuite()
